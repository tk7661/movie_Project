        ...
        <div style="margin:0 auto;width:1100px;padding-top:25px; padding-left:25px; display:flex; display-direction:row; justify-content:space-between;">
            ...
            <div class="submenu" style="padding-left:30px;">
                <ul style="display:flex; display-direction:row; list-style-type:none;" class="sort">
                    <li id="chart1"style="text-align:left; width:70px; padding-right:0px;" class="sortTab"><a href="#" onclick="chart1()">무비차트<span class="arrow-down"></span></a></li>
                    <li id="chart2"style="width:110px;text-align:left; padding-left:10px;" class="sortTab on"><a href="#" >상영예정작<span class="arrow-down"></span></a></li>
...
<div style="width:1200px; margin:0 auto;" id="showMovieList">
	<c:forEach var="mcount" begin="0" end="${ecount/4}" varStatus="status">
		<c:choose>
			<c:when test="${status.last}">
			<ol style="display:flex; flex-direction:row;">
            	<c:forEach var="movie" items="${elist}" begin="${4*mcount+0}" end="${ecount}" varStatus="status1">
            ...
            <c:otherwise>
	            <ol style="display:flex; flex-direction:row;">
	            <c:forEach var="movie" items="${elist}" begin="${4*mcount+0}" end="${3+mcount*4}" varStatus="status2">
	            <li style="list-style-type:none; padding-left:40px;padding-right:40px;">
